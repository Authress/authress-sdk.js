...
export interface ResourcesApi {
   ...
   * @throws {ArgumentRequiredError}
   */
  updateResourcePermissions(resourceUri: string, body: ResourcePermissions): Promise<Response<void>>;
}
...
declare class AuthressClient {
  constructor(settings: AuthressSettings, tokenProvider: () => string): AuthressClient;
