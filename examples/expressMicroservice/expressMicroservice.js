...
const authressServiceClient = new AuthressClient({ baseUrl: 'https://DOMAIN.api-REGION.authress.io' }, new ServiceClientTokenProvider(serviceClientAccessKey));
...
api.use((request, response, next) => {
  ...
  response.locals.authressClient = new AuthressClient({ baseUrl: 'https://DOMAIN.api-REGION.authress.io' }, () => token);
